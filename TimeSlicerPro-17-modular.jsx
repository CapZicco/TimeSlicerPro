/*
 * TimeSlicerPro v17.04 
 * by CapZicco & Copilot
 * - Funzionalità Oval e Spiral prese direttamente dalla versione minimal funzionante.
 * - Integrazione completa con GUI e logica di v17.03.
 */
...
(function() {
    ...
    // OVAL PATCH minimal (exactly as provided in minimal version)
    ...
    // SPIRAL PATCH minimal (exactly as provided in minimal version)
    ...
    function showDialog(settings) {
        var prefs = settings;
        var myWin = new Window("dialog", "TimeSlicerPro v17.04");
            ...
            for (var i = 0; i < len; i++) {
                ...
                switch (settings.outputPattern) {
                    ...
                    case "Radial Slices":
                        ...
                        break;
                    case "Spiral Stripes":
                        selectSpiralStripe(i, settings.spiralStripesNum || len, settings.stripeTwist || 4, settings.w, settings.h);
                        break;
                    default:
