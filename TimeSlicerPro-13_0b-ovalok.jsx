/*
 * TimeSlicerPro v13.03
 * Full English version with all options and "Radial Order" for "Radial Slices (Pie)"
 * by CapZicco & Copilot
 */
    ...
    for (var z = app.activeDocument.artLayers.length - 1; z >= 0; z--) { 
        ...
        switch (TSclass.p.outputPattern) { 
            ...
            case "Radial Slices (Pie)":
                if (TSclass.p.shadow && TSclass.p.shadow.toLowerCase() == "forward") {
                    al.duplicate(folderRef, ElementPlacement.PLACEATBEGINNING);
                } else {
                    al.duplicate(folderRef, ElementPlacement.PLACEATEND);
                }
...
var tsVersion = "1.93-RADIAL-ORDER-ENG";
...
TSclass.SliceIt = function () {
    ...
    if (TSclass.p.outputType && TSclass.p.outputType.toLowerCase() == "jpg") {
        TSclass.myAlert("JPG");
...
// END PART 1
// =========================
// 3. MAIN DIALOGS & UI (English, with Radial Order for Radial Slices)
// =========================
...
TSclass.dialogAndSetOptions = function () {
    ...
    // OUTPUT PATTERN (with Radial Slices (Pie))
