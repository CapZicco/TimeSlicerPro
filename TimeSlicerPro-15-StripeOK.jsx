/*
 * TimeSlicerPro v15.x - FULL SCRIPT
 * by CapZicco & Copilot
 * Basato su v13 funzionante, con:
 * - closeFile unificata
 * - saveImage unificata
 * - path synthesis ottimizzata
 * - Spiral Stripes patchata e funzionante
 * - Tutta la struttura, dialog, shadow, log, ecc.
 */
...
TSclass.maskIt = function (i, len) {
    ...
    switch (TSclass.p.outputPattern) {
        ...
        case "Radial Slices":
            ...
            break;
        case "Spiral Stripes":
            TSclass.selectSpiralStripe(i, len, TSclass.p.stripeTwist || 4, TSclass.p.w, TSclass.p.h);
            break;
        case "Radial":
        case "Circular":
            alert("to do");
...
TSclass.setPreferences = function () {
    TSclass.p = TSclass.p || {};
    TSclass.p.inputFolder = TSclass.p.inputFolder || "~";
    TSclass.p.outputFolder = TSclass.p.outputFolder || "~";
    TSclass.p.outputFile = TSclass.p.outputFile || "output";
    TSclass.p.outputType = TSclass.p.outputType || "jpg";
    TSclass.p.outputPattern = TSclass.p.outputPattern || "Vertical Slices Left To Right";
    TSclass.p.outputQuality = TSclass.p.outputQuality || 12;
    TSclass.p.shadow = TSclass.p.shadow || "no";
    TSclass.p.shadowOpacity = TSclass.p.shadowOpacity || 10;
    TSclass.p.shadowDist = TSclass.p.shadowDist || 5;
    TSclass.p.shadowSpread = TSclass.p.shadowSpread || 0;
    TSclass.p.shadowSize = TSclass.p.shadowSize || 5;
    TSclass.p.shadowAngle = TSclass.p.shadowAngle || 120;
    TSclass.p.shadowColor = TSclass.p.shadowColor || "#000000";
    TSclass.p.radialOrder = TSclass.p.radialOrder || "center";
...
TSclass.dialogAndSetOptions = function () {
    var prefs = TSclass.p;
    var myWin = new Window("dialog", "TimeSlicerPro v" + (typeof tsVersion !== "undefined" ? tsVersion : "15"));
