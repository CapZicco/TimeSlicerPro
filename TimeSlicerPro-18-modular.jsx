/*
 * TimeSlicerPro v18.00
 * by CapZicco & Copilot
 * - Funzionalità Oval e stripe
 * - Integrazione completa con GUI e logica 
 */
...
(function() {
    ...
    function writeLog(msg, outputFolder, enabled) {
        ...
        txtFile.open("a");
        txtFile.writeln("v18 | " + datetime + ": " + msg);
        txtFile.close();
    }
    ...
    function showDialog(settings) {
        var prefs = settings;
        var myWin = new Window("dialog", "TimeSlicerPro v18.00");
...
case "Oval-Circular Slices Inside-Out":
    ...
    break;
                    ...
                    case "Radial Slices":
                        ...
                        break;
case "Spiral Stripes":
    // Fa sì che il numero di spire sia sempre quello delle immagini trovate
    var numSpirals = len;
