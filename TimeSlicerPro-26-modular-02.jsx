...
function collectSettingsFromGui() {
    return {
        ...
        numSlices: (typeof txtClassicHorizontalSlices !== "undefined") ? txtClassicHorizontalSlices.text : "",
        shadow: (typeof chkShadow !== "undefined") ? chkShadow.value : false
        // aggiungi altri parametri della GUI se li hai (usa solo questi 3 per ora)
    };
}
...
function applySettingsToGui(settings) {
    ...
    if (settings.numSlices && typeof txtClassicHorizontalSlices !== "undefined") txtClassicHorizontalSlices.text = settings.numSlices;
    if (typeof chkShadow !== "undefined" && settings.shadow !== undefined) chkShadow.value = settings.shadow;
}
