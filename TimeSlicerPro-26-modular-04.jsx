...
// === [ FINE BLOCCO 2 ] ===
// ====================================================================
// === TimeSlicerPro v27 – BLOCCO 3: GUI TECH, PATTERN, DISPATCHER ====
// ====================================================================

// === [ CREDITS / INFO ] ===
/*
    TimeSlicerPro v27 – GUI Tech edition
...
// === [ GLOBALS & CONSTS ] ===
var SCRIPT_NAME = "TimeSlicerPro";
var SCRIPT_VERSION = "v27.00";
var DEBUG_MODE = true;

// === [ PATTERN TOOLTIP DESCRIPTIONS ] ===
var patternDescriptions = [
    "Slicing: Orizzontale, dall’alto verso il basso.",
    "Slicing: Orizzontale, dal basso verso l’alto.",
    "Slicing: Verticale, da sinistra a destra.",
    "Slicing: Verticale, da destra a sinistra.",
    "Slicing: Diagonale principale (↘).",
    "Slicing: Diagonale anti (↙).",
    "Slicing: Triangle – Alto livello, suddivisione triangolare.",
    "Scacchiera: righe & colonne.",
    "Griglia esagonale.",
    "Anelli ovali concentrici (in/out).",
    "Puzzle 2D: righe & colonne.",
    "Puzzle 1D: strisce orizzontali/verticali.",
    "Settori radiali (tipo torta).",
    "Spirale a bande.",
    "Raggi tipo sunbeam.",
    "Onde sinusoidali."
];
...
var lblSubtitle = gTitle.add("statictext", undefined, "Modular, batch-ready, tech GUI – v27 – by CapZicco & Copilot");
...
myWin.show();
// ====================================================================
// === TimeSlicerPro v27 – BLOCCO 4: RENDER/PREVIEW PLACEHOLDER =======
// ====================================================================
...
// === [ FINE BLOCCO 4 ] ===
// ====================================================================
// === TimeSlicerPro v27 – BLOCCO 5: UTILITY, SETTINGS, PROGRESS  =====
// ====================================================================
...
// === [ FINE BLOCCO 5 ] ===
// ====================================================================
// === TimeSlicerPro v27 – BLOCCO 6: EXTRA UTILITY & SPECIALS      ====
// ====================================================================
...
// Esempio uso:
// setParamTooltip(gHorizontal, "Numero di bande orizzontali");
...
function checkRequiredFields() {
    if (!txtSourceDir.text) {
        alert("Seleziona una cartella sorgente immagini!");
        return false;
    }
    if (!txtDestDir.text) {
...
// === [ FINE BLOCCO 6 ] ===
// =====================================================================
// === TimeSlicerPro v27 – BLOCCO 7: BATCH, ERROR, STATS, DEBUG     ====
// =====================================================================
...
// === [ FINE BLOCCO 7 ] ===
// ====================================================================
// === TimeSlicerPro v27 – BLOCCO 8: PARAMETRI DINAMICI & PRESET   ====
// ====================================================================
...
// === [ FINE BLOCCO 8 ] ===
// =====================================================================
// === TimeSlicerPro v27 – BLOCCO 9: HELP, ABOUT, TOOLTIP, DOCS     ====
// =====================================================================
...
// === [ FINE BLOCCO 9 ] ===
// =====================================================================
// === TimeSlicerPro v27 – BLOCCO 10: ESTENDIBILITÀ, HOOKS, PLUGIN  ====
// =====================================================================
