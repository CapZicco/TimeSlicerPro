...
function runClassicHorizontal() {
    try {
        ...
        var progressWin = ProgressWindow(numSlices, "Horizontal Progress");
...
function runClassicVertical() {
    try {
        ...
        var progressWin = ProgressWindow(numSlices, "Vertical Progress");
